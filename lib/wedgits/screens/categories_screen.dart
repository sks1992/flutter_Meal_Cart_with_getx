...
import 'package:untitled/wedgits/items/category_items.dart';
  ...
  Widget build(BuildContext context) {
    return
      ...
      GridView(
        ...
        //In Children we pass a constant list of DUMMY_CATEGORY data that maps
        //to CategoryItems. we use toList because map return a Iterable.Map have
        // a function that list and connect to CategoryItem
